...
public class Grade {
    ...
    public double percentage(float m1, float m2, float m3, float m4, float m5) {
        float sum = m1 + m2 + m3 + m4 + m5;
        double per = (sum / 5.0);
    ...
    public static void main(String[] args) {
        ...
        Grade obj = new Grade(); // creating an object
        obj.Totalmarks(marks1, marks2, marks3, marks4, marks5);
        obj.percentage(marks1, marks2, marks3, marks4, marks5);
